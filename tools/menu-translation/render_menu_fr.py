...
from menu_fr_data import COVER, PAGES, ALLERGENS
...
def render_allergen_page():
    ...
    d.text((x + en_w, y + 4), "Allergènes", font=f_h1_ru, fill=RED)
    y += 60
...
def load_photo_page(num):
    ...
    ru = "Les noms des plats et les prix figurent sur la page précédente"
...
def main():
    ...
    out = os.path.join(REPO_DIR, "assets", "menu-fr.pdf")
