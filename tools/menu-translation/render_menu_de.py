...
from menu_de_data import COVER, PAGES, ALLERGENS
...
def render_allergen_page():
    ...
    d.text((x + en_w, y + 4), "Allergene", font=f_h1_ru, fill=RED)
    y += 60
...
def load_photo_page(num):
    ...
    ru = "Gerichtnamen und Preise finden Sie auf der vorherigen Seite"
...
def main():
    ...
    out = os.path.join(REPO_DIR, "assets", "menu-de.pdf")
